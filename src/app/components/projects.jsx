...
animate={{opacity: 1}}>
    ...
    <div className="grid grid-cols-auto grid-rows-auto grid-flow-row place-items-center mt-5 w-1/2 mx-auto">
      <Link className="mont mx-auto text-center bg-white px-6 py-2 rounded-xl shadow-sm border border-stone-100 hover:shadow-md transition-shadow hover:cursor-pointer" href="./widget"><img className="w-10 h-10 mx-auto" src="/icons/Widget.svg"></img><p className="mt-3">Widget & Co.</p></Link>
    </div>
  </motion.div>
)}
        ...
        <div className="bg-black pb-3 h-full">
            <div className="flex flex-row items-center w-full">
                <div className="flex flex-row items-center w-full mt-6">
                    <h1 className="text-white w-3/4 mx-auto text-5xl tracking-widest inst">Widget & Co.</h1>
                </div>
                <div className="flex flex-row items-center w-full mt-6">
                    <p className="text-white w-auto mx-auto underline isnt">Home</p>
                    <p className="text-white w-auto mx-auto underline isnt">About</p>
                    <p className="text-white w-auto mx-auto underline isnt">Contact us</p>
                    <p className="text-white w-auto mx-auto underline isnt">Our Partners</p>
                </div>
            </div>
            <div className="mt-20">
            ...
            <div className="flex flex-row items-center mx-auto">
                <h3 className="text-white mt-10 w-1/2 mx-auto text-center underline text-3xl tracking-widest isnt">Get a quote</h3>
                <h3 className="text-white mt-10 w-1/2 mx-auto text-center underline text-3xl tracking-widest isnt">View our work</h3>
            </div>
            <div className="mt-24">
                ...
                <h3 className="text-white mt-6 mx-auto text-center underline text-3xl tracking-widest isnt">Book an appointment</h3>
            </div>
